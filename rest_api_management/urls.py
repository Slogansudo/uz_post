...
from .views import (UsersAPIView, UsersDetailAPIView, UserRequestsView, UsersRequestsDetailView, MyProfileView, BannerAPIViewSet, MenuElementsAPIViewSet, MenuAPIViewSet,
